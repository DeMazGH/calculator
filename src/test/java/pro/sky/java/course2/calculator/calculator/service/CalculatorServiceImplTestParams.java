...
public class CalculatorServiceImplTestParams {
    ...
    public static final Integer NUM_1 = 3;
    public static final Integer NUM_2 = 4;
    public static final Integer NUM_3 = -4;
    public static final Integer NUM_4 = -5;

    @ParameterizedTest
    @MethodSource("calculateTestParam")
    ...
    public static Stream<Arguments> calculateTestParam() {
        return Stream.of(
